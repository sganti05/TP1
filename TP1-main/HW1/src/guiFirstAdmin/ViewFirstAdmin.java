...
public class ViewFirstAdmin {
	...
	private ViewFirstAdmin() {
		...
		text_AdminUsername.textProperty().addListener((observable, oldValue, newValue) -> { 
		    ...
		    ViewFirstAdmin.label_PasswordsDoNotMatch.setText("");  // Clear any previous error message
		});

		// Initialize the Admin password 1 field
		...
		// Initialize the Admin password 2 field
